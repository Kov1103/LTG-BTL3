...
from PlatformDebris import PlatformDebris0, PlatformDebris1
...
class Map(object):
    ...
    def loadWorld_11(self):
        ...
        self.mobs.append(Koopa(1632, 352, False))
    ...
    def spawn_debris(self, x, y, type):
        if type == 0:
            self.debris.append(PlatformDebris0(x, y))
        elif type == 1:
    ...
    def try_spawn_mobs(self, core):
        ...
        if self.get_player().rect.x > 2080 and not self.is_mob_spawned[0]:
            ...
            self.spawn_goombas(3550, 352, False)
            self.spawn_goombas(3760, 352, False)
            self.spawn_goombas(3600, 352, True)
            self.spawn_goombas(3744, 352, True)
            self.spawn_goombas(3648, 352, False)
            self.spawn_goombas(3680, 352, False)
            self.spawn_goombas(3712, 352, False)
